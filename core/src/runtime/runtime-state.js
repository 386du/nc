...
function createRuntimeState(options) {
    ...
    function buildConfigSnapshotForAccount(accountId) {
        ...
        const accounts = accountsData && Array.isArray(accountsData.accounts) ? accountsData.accounts : [];
        const account = accounts.find(a => String(a && a.id) === String(accountId));
        return {
            ...
            friendGuardDogBlacklist: store.getFriendGuardDogBlacklist(accountId),
            friendGuardDogWhitelist: store.getFriendGuardDogWhitelist(accountId),
            friendGuardDogGids: store.getFriendGuardDogGids(accountId),
