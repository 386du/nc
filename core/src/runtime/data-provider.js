    ...
    return {
        ...
        refreshAccountCode: async (accountRef, code) => {
            ...
            if (!worker) {
                ...
                addAccountLog('code_start', `已获取新 Code，正在启动账号 ${nextCode.substring(0, 8)}...`, accountId, acc.name, { reason: 'code_capture_start' });
            ...
            addAccountLog('code_restart', `已获取新 Code，正在重新登录账号 ${nextCode.substring(0, 8)}...`, accountId, acc.name, { reason: directRestartReason });
