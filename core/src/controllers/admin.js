...
const mountYybRoutes = require('./admin/yyb-routes');
...
app.use('/api', (req, res, next) => {
    ...
    // ============ 应用宝登录配置 ============
    // 拆出到 controllers/admin/yyb-routes.js,这里只挂载
    mountYybRoutes(app, { store, authRequired });
    ...
    const port = CONFIG.adminPort || 3338;
